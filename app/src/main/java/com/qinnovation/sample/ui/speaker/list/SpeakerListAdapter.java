...
public class SpeakerListAdapter extends BaseRecyclerViewAdapter<SpeakerDetail> implements OnViewClickListener {

    private SpeakerListActivity speakerListActivity;
    private OnRecyclerViewClickListener onRecyclerViewClickListener;


    SpeakerListAdapter(SpeakerListActivity speakerListActivity, OnRecyclerViewClickListener onRecyclerViewClickListener) {

        this.speakerListActivity = speakerListActivity;
